...
import {
  ...
  is,
  tc
} from "./chunk-GTAUOITM.js";
import "./chunk-3FBIQ4L5.js";
import "./chunk-HCX2A67F.js";
import {
  i,
  scope
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await import("./react-18-J3ZXLDVT.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react2.default.createElement(Story, { ...storyContext }) : import_react2.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react2.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react2.default.createElement(Wrapper, null, content) : content;
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./test-3U2LAT2B.js"), act = await getAct();
